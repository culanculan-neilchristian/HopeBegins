    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="font-black italic uppercase tracking-widest text-xs text-zinc-400">
            Loading templates...
          </p>
        </div>
      </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Link
              ...
              className="text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-brand transition-colors"
            >
              Daily Hope
            </Link>
        ...
        <aside className="lg:col-span-3 space-y-4">
            ...
            <div className="max-h-[600px] overflow-y-auto custom-scrollbar p-2 space-y-1">
              {templates.map((t) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`h-8 w-8 rounded-xl flex items-center justify-center font-black text-sm ${
                        selectedTemplate?.id === t.id
                          ? 'bg-white/20'
          ...
          <div className="p-6 bg-amber-50 dark:bg-amber-900/10 rounded-3xl border border-amber-100 dark:border-amber-900/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-black text-amber-900 dark:text-amber-200 text-xs uppercase tracking-wider mb-1">
                  Important
                </h4>
                <p className="text-xs text-amber-700/80 dark:text-amber-300/60 leading-relaxed font-medium">
                  Be careful with layout changes. These emails use standard HTML
                  tables for maximum compatibility with email clients like
                  Outlook.
                </p>
              </div>
            </div>
        ...
        <main className="lg:col-span-9 space-y-6">
          {selectedTemplate ? (
            ...
            <div className="h-[600px] rounded-3xl border-2 border-dashed border-zinc-100 flex items-center justify-center">
              <p className="text-zinc-400 font-black uppercase tracking-widest text-xs italic">
                Select a day to start editing
              </p>
            </div>
          )}
        </main>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-zinc-500 font-medium text-sm mt-1">
                  This is how the email will look to subscribers.
                </p>
              </div>
